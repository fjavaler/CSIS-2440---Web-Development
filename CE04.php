        ...
        <div id="main">
            <form action="CE04.php" method="post">
                ...
                if ($_POST['sneaky'] == 0)
                {
                    ...
                    Gender: F<input type="radio" value="F" name="Gender" checked>  M<input type="radio" value="M" name="Gender"><br>
...
//                    }
                    ...
                    printf("This is a story about a %s named %s<br> who at only the age of %d is a %s<br> "
                            . "This is the start of the story....<br>", $title, $name, $age, $class);

                    echo '<ul><li>' . $settings[0] . '</li><li>' . $objectives[0] . '</li><li>' . $antagonists[0]
                    . '</li><li>' . $complications[0] . "</li></ul><br><input type='submit' value='Try Again' name='Create'><br>"
